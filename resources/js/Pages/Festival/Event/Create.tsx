                        ...
                        <FormCard title="Formulir Event">
                            <FormGroup title="Informasi Event">
                                ...
                                <Select
                                    ...
                                    {...form.getInputProps("eventable_type")}
                                    data={[
                                        {
                                            value: "competition",
                                            label: "Kompetisi",
                                ...
                                <TextInput
                                    description="Masukkan tanpa titik"
                                    withAsterisk
                                    label="Biaya"
                                    icon="Rp"
                                ...
                                />
                                <TextInput
                                    placeholder="Diadakan di"
                                    label="Diadakan di"
                                    {...form.getInputProps("held_in")}
                                />
                                <DateInput
                                    placeholder="Diadakan pada"
                                    label="Diadakan pada"
                                    {...form.getInputProps("held_on")}
                                />
                                <TextInput
                                    description="Masukkan URL link grup WhatsApp."
                                    withAsterisk
                                    placeholder="Link grup"
                                    label="Link grup"
                                    {...form.getInputProps("group_link")}
                                />
                            </FormGroup>
                            {form.values.eventable_type ==
                                EventType.COMPETITION && (
                                <FormGroup title="Informasi Kompetisi">
                                    <NumberInput
                                        withAsterisk
                                        description="Masukan angka 1 jika individual."
                                        label="Maks peserta"
                                        {...form.getInputProps(
                                            "max_participants"
                                        )}
                                    ...
                                    <TextInput
                                        withAsterisk
                                        description="Masukan url form pengumpulan submission."
                                        label="URL submission"
                                        {...form.getInputProps("submission")}
                                    />
                                </FormGroup>
                            )}
                            {form.values.eventable_type ==
