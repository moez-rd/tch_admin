        ...
        <FestivalLayout>
            ...
            <SectionContent>
                <Box sx={{display: "flex", justifyContent: "space-between", alignItems: "end"}}>
                    ...
                    <Group spacing="4px">
                        <Button component={Link} href={route('faqs.edit', {faq: faq.id})} size="xs" color="yellow"
                                leftIcon={<IconPencil/>}>Edit</Button>

                        <Button onClick={(e) => handleDelete(e, faq)} size="xs" color="red"
                                leftIcon={<IconTrash/>}>Hapus</Button>
                    </Group>
                </Box>
                <Box pt="0.625rem">
                    <DescriptionList title={faq.question} data={displayFaq(faq)}/>
                </Box>
            </SectionContent>
        </FestivalLayout>
    )
